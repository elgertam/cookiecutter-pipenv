...
copyright = '2019, Andrew Mark Elgert'
...
htmlhelp_basename = 'cookiecutter-pipenvdoc'
...
man_pages = [
    (master_doc, 'cookiecutter-pipenv', 'cookiecutter-pipenv Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cookiecutter-pipenv', 'cookiecutter-pipenv Documentation',
   author, 'cookiecutter-pipenv', 'One line description of project.',
   'Miscellaneous'),
]
