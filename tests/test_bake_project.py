...
def test_bake_and_run_travis_pypi_setup(cookies):
    ...
    with bake_in_temp_dir(cookies) as result:
        ...
        # when:
        venv_setup_cmd = 'pipenv install --dev'
        travis_setup_cmd = ('pipenv run python travis_pypi_setup.py'
                            ' --repo elgertam/cookiecutter-pipenv --password invalidpass')
        run_inside_dir(venv_setup_cmd, project_path)
